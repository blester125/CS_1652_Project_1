...
client: http_client.cc
	c++ $(cflags) -o bin/http_client http_client.cc

server1: http_server1.cc
	c++ $(cflags) -o bin/http_server1 http_server1.cc

server2: http_server2.cc
	c++ $(cflags) -o bin/http_server2 http_server2.cc

server3: http_server3.cc
	c++ $(cflags) -o bin/http_server3 http_server3.cc
